...
#SBATCH --output=/scratch/project_00000000/test-time-facts-cache/training_logs/fine-tune-multinode_4_8-%A_%a.out
#SBATCH --error=/scratch/project_00000000/test-time-facts-cache/training_logs/fine-tune-multinode_4_8_%A_%a.ERROR.out
...
do
    ...
    accelerate launch \
      ...
      sft_fs1.py \
            ...
            --save_steps 550 \
            --save_total_limit 1 \
            --output_dir /scratch/project_00000000/test-time-facts-cache/tmp-14-72B/$(basename $MODEL | tr / -)-rt \
        "
