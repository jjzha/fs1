...
#SBATCH --output=/scratch/project_000000000/cache/training_logs/fine-tune-multinode_2_8-%A_%a.out
#SBATCH --error=/scratch/project_000000000/cache/training_logs/fine-tune-multinode_2_8_%A_%a.ERROR.out
